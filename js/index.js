...
window.setInterval(function(){
    ...
    /*$('.title').text("We've been together for " + d + " days, " + h + " hours, " + m + " minutes, " + s + " seconds.");*/
	$(".seconds").attr('data-attr', s + " seconds");
	$(".minutes").attr('data-attr', m + " minutes");
	$(".hours").attr('data-attr', d + " ds, " + h + " hs");
